    ...
    <div class="page-header">
        <div class="container">
            <div class="page-header-content">
                ...
                <a href="${pageContext.request.contextPath}/MainController?action=category_showCreate" class="btn btn-primary">
                    + Add New Category
                </a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="category" items="${categories}">
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a href="${pageContext.request.contextPath}/MainController?action=category_showEdit&typeId=${category.typeId}" 
                                       class="btn btn-warning btn-sm">Edit</a>
                                    <c:if test="${sessionScope.role >= 1}">
                                        <a href="${pageContext.request.contextPath}/MainController?action=category_delete&typeId=${category.typeId}" 
